    ...
    <div class="header-container bg-bule">
      <div class="header-top">
        ...
        <div class="right"  @click="openDialog">
          ...
          <template v-if="isAuthenticated" ><a @click="gotozone">个人中心</a>  |  <a> 注销 </a> </template>
          <template v-else="isAuthenticated" ><a>  登录  </a> </template>
...
export default {
  data(){
    ...
    return {
      ...
      // isLoginShown: false,
      // isLogoutShown: false,
      isLoginShown: this.$store.state.isLoginShown,
      isLogoutShown: this.$store.state.isLogoutShown,
      isLoginByCode: false,
  ...
  computed: {
    ...
    // },
    // isLogoutShown(){
    //   return this.$store.state.isLogoutShown
    // }
  ...
  methods:{
    ...
    openDialog() {
      if (this.isAuthenticated) {
        ...
        this.$store.commit("setIsLogoutShown",true)
      } else {
        // this.isLoginShown = true;
        this.$store.commit("setIsLoginShown",true)
      }
    },
    closeLogin() {
      // this.isLoginShown = false;
      this.$store.commit("setIsLoginShown",false)
    },
      ...
      if (response.success) {
        ...
        this.$message({
          ...
          onClose() {
            ...
            self.$store.commit("setIsLogoutShown",false)
            self.$emit('logout');
