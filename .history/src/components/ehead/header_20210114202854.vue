...
export default {
 ...
 beforeRouteEnter (to, from, next) {
   ...
   created() {
    ...
    // this.isAuthenticated = !!(this.$utils.cookie.get('token'));
    this.authUser();
    console.log("this.token1111",this.token)
      if(!this.token){
  ...
  //     console.log("islogin newValue",newValue)
  //     if(newValue==true){
  //       console.log("我是不是")
  //       this.$message({
  //         type: 'warning',
