...
//         });
    ...
    function dragImage(){
      ...
      $(".wrapper", wrapper_geral).on("mousedown",".dragme",function(e){
        ...
        _this = $(this)
        var scrollX = getSize(_this, 'scrollTop');
        var scrollX = getSize(_this, 'scrollLeft');
        var distenceX = e.pageX - getSize(_this, 'left');
        var distenceY = e.pageY - getSize(_this, 'top');
        console.log("this1111111111111",_this)
        console.log("this1111111111111",e.pageX,e.pageY)
        console.log("thisscrolltop",scrollX,scrollY)

        console.log("this1111111111111",getSize(_this, 'left'),getSize(_this, 'top'))
      ...
      $(".wrapper", wrapper_geral).on("mouseup",".dragme",function(e){
