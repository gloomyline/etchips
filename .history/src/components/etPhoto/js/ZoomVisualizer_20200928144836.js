...
(function ($) {
  ...
  $.fn.ZoomVisualizer = function (method) {
    ...
    function initialize($this) {
      ...
      btZoomOut = $(wrapper_geral.find(".dragme"));
      ...
      wheelZoomImg = $(wrapper_geral.find(".content .wrapper"))
      console.log("dragme",wheelZoomImg)

      
     
        wheelZoomImg.bind("DOMMouseScroll", function() {
          console.log("使用了滚轮")
