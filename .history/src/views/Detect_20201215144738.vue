  ...
  <div class="container">
    ...
    <div class="wrapper">
      ...
      <div class="content">
        ...
        <div class="subtitle">
         亲爱的客户，从您申请委托检测服务成功后，检测报告需要10个工作日，检测报告完成后，我们会在2个工作日将按照检测配送地址以快递方式为您寄送一般快递寄送时间在2-3天内，请您耐心等待。<span>也可以通过检测报告提取码来预览和下载报告</span>
        </div>
        <div class="form">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        brand: [{ required: true, message: '请输入ss称', trigger: 'blur' }],
        remark: [{ required: true, message: '请输入aa称', trigger: 'blur' }],
      },
