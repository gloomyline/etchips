          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px">
            ...
            <el-form-item label="检测项">
              <el-checkbox-group v-model="ruleForm.checkeditems">
                ...
                <el-checkbox label="X-ray" name="type" border></el-checkbox>
                <el-checkbox label="de-cap(开盖)" name="type" border></el-checkbox> -->
                <el-checkbox v-for="item in ruleForm.items" name="type" :disabled="item.disabled"  :label="item.content" border></el-checkbox>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        checkeditems:[{ required: true, message: '请选择检测项', trigger: 'change' } ],
  ...
  watch:{
    'form.back':{
      handler(newValue){
        ...
        if(newValue == '寄回'){
          this.form.items[2].disabled=true
          console.log("thischeckeditems",this.form.checkeditems)
          var index =this.form.checkeditems.indexOf("de-cap(开盖)")
          this.form.checkeditems.splice(index,1)
          console.log("thischeckeditems222",this.form.checkeditems)

        }else{
          this.form.items[2].disabled=false
        }
