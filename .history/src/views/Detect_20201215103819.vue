      ...
      <div class="content">
        ...
        <div class="form">
          ...
          <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="80px">
            ...
            <el-form-item label="检测项">
              <el-checkbox-group v-model="ruleForm.checkeditems"  prop="items" >
                <!-- <el-checkbox label="外观检测" name="type" border></el-checkbox>
                <el-checkbox label="X-ray" name="type" border></el-checkbox>
                <el-checkbox label="de-cap(开盖)" name="type" border></el-checkbox> -->
                <el-checkbox v-for="item in ruleForm.items" name="type" :key = "item.content" :disabled="item.disabled"  :label="item.content" border></el-checkbox>
