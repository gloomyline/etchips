          ...
          <el-form ref="form" :model="form" label-width="80px">
            ...
            <el-form-item label="检测项">
              <el-checkbox-group >
                ...
                <el-checkbox v-for="(item,i) in form.type" :key="i" :label="item.content" :disabled="item.disabled" border name ="type"></el-checkbox>
              </el-checkbox-group>
            </el-form-item>
...
export default {
  ...
  data() {
    return {
      form: {
        type: [
          {id:0,disable:false,content:"外观检测"},
          {id:1,disable:false,content:"X-ray"},
          {id:2,disable:false,content:"de-cap(开盖)"},
        ],
        back: '',
        material: '',
        brand: '',
