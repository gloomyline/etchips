  ...
  <div class="home">
    ...
    <!-- <div class="et-module-nav">
      <ul class="modules"> -->
        ...
        <!-- 客户服务，可用提取码查看 -->
        <!-- <li class="module"><router-link to="/report-download"><img src="@/assets/icon-files-download.png" alt="" class="icon" width="64" height="64"><p class="label">客户服务</p></router-link></li> -->
        <!-- 数据申请，会员用于申请增加样品数据 -->
...
import homeheader from '@/components/ehead/homeheader';
import banner from '@/components/ehead/banner.vue';
import api from '@/api';
import services from '@/components/ehome/Services.vue';
import hotSearch from '@/components/ehome/HotSearch.vue';
import latestData from '@/components/ehome/LatestData.vue';
import feedback from '@/components/ehome/Feedback.vue';
import news from '@/components/ehome/News.vue';
import partner from '@/components/ehome/Partner.vue';
...
export default {
  ...
  components: { EtCarousel ,homeheader,banner,services,hotSearch,latestData,news,partner,feedback},
  beforeCreate(){
