    ...
    <div class="container">
     ...
     <!-- <el-tabs type="border-card"> -->
        ...
        <!-- <el-tab-pane label="增值税纸质普通发票"> -->
          <!-- 表单开始 -->
          <el-form ref="form" :model="form" :rules="rules" label-width="150px" width="600" class="form">
            <div class="formTitle"> 
              发票填写信息<br>
            </div>
            <el-form-item label="选择购买项目" prop="orderNumber">
            ...
            <el-form-item label="发票抬头" prop="invoiceId">
  ...
  export default {
    data() {
      return {
        ...
        rules:{
          orderNumber: [
            { required: true, message: '请选择已购买的订单项目', trigger: 'change' }
          ],
          invoiceId: [
            { required: true, message: '请选择公司抬头', trigger: 'change' }
          ],
          addressId: [
    ...
    methods: {
      ...
      async submitForm(formName) {
        ...
        const applyInvoice = await api.userzone.applyInvoice(invoicelist)
        this.$message({
          type: 'success',
          message: applyInvoice.msg,
