      ...
      <div class="content">
        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="form">
          <el-form-item label="手机号" prop="mobile">
            ...
            <el-input v-bind:value="ruleForm.mobile" disabled></el-input>
          </el-form-item>
...
export default {
   data() {
    ...
    async created(){
      ...
      this.ruleForm.mobile =  userinfo.mobile.replace(/^(\d{3})\d{4}(\d+)/,"$1****$2")
      this.ruleForm.mobilereg =  userinfo.mobile.replace(/^(\d{3})\d{4}(\d+)/,"$1****$2")
