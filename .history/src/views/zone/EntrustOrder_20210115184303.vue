        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
             ...
             <div><el-button type="primary" v-if='scope.row.payStatus == 0' size="mini" @click="gotopay(scope.$index, scope.row)">去支付</el-button></div>
             <div><el-button type="primary" v-if='scope.row.examineStatus == 0' size="mini" >取消订单</el-button></div>
