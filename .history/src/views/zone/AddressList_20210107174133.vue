            ...
            <el-col :span="6">
              <el-form-item prop="provinceName">
                <el-select v-model="form.provinceName" placeholder="请选择省">
                  <el-option v-for="item in form.provinceNamelist" :label="item.id" value="item.name" :key="item.id">{{item.name}}</el-option>
...
export default {
  ...
  async created(){
    ...
    this.form.provinceNamelist = JSON.parse(provinceName.msg)
