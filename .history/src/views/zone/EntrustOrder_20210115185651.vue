        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
             ...
             <div class="btn"><el-button type="primary" v-if='scope.row.examineStatus == 0' size="mini"  @click="gotocancel(scope.$index, scope.row)">取消订单</el-button></div>
...
export default {
  ...
  methods:{
   ...
   async gotocancel(index,row){
     ...
     const res = await api.userzone.orderCancel(row.orderNumb)
