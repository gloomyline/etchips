        ...
        <!-- <el-tab-pane label="增值税纸质普通发票"> -->
          ...
          <el-form ref="form" :model="form"  label-width="150px" width="600">
            ...
            <el-form-item label="发票抬头">
              <el-select v-model="form.title" placeholder="请选择购买选项" @change="titleselected">
                <el-option v-for="item in form.invoicecompany" :label="item.label" :value="item.value" :key="item.id" ></el-option>
                <!-- <el-option label="订单1" value="order1"></el-option>
                <el-option label="订单2" value="order2"></el-option> -->
              </el-select>
            </el-form-item>
