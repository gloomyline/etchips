        ...
        <!-- <el-tab-pane label="增值税纸质普通发票"> -->
          ...
          <el-form ref="form" :model="form"  label-width="150px" width="600">
            ...
            <el-form-item label="纳税人识别号">
              <el-input v-bind:value="form.invoiceTaxNumber" placeholder="个人发票，纳税识别号不填" disabled></el-input>
            </el-form-item>
            <!-- <el-form-item label="发票内容">
              <el-input v-model="form.content"></el-input>
            </el-form-item> -->
            <el-form-item label="收件人">
              <el-select v-model="form.addressId" placeholder="请选择地址薄里的收件人" @change="addressselected">
                <el-option v-for="item in form.invoicecompanylist" :label="item.label" :value="item.value" :key="item.id" ></el-option>
                <!-- <el-option label="订单1" value="order1"></el-option>
                <el-option label="订单2" value="order2"></el-option> -->
              </el-select>
            ...
            <el-form-item label="收件人手机">
              <el-input v-bind:value="form.invoiceTaxNumber" placeholder="选择收件人后自动填充收件人手机" disabled></el-input>
            </el-form-item>
            <el-form-item label="收件人地址">
              <el-input v-bind:value="form.invoiceTaxNumber" placeholder="选择收件人后自动填充收件人地址" disabled></el-input>
            </el-form-item>
  ...
  export default {
    ...
    methods: {
      async getAllAddress(){
        ...
        this.addressAllList=allAddress.data
      },
      async selected(val){
        console.log("val",val)
