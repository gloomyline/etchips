          ...
          <el-form-item label="地址信息" required>
            <el-col :span="6">
              <el-form-item prop="date1">
                <el-select v-model="form.provinceName" placeholder="请选择活动区域">
                  <el-option v-for="item in form.provinceNamelist" label="区域一" value="shanghai"></el-option>
                  {{form.provinceName}}
...
export default {
  ...
  async created(){
    ...
    this.form.provinceNamelist = provinceName
