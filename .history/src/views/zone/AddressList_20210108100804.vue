          ...
          <el-form-item label="地址信息" required>
            ...
            <el-col :span="6">
              <el-form-item prop="cityName">
                <el-select v-model="form.cityName" placeholder="请选择市">
                  ...
                  <el-option v-for="item in form.cityNamelist" :label="item.name" :value="item.id" :key="item.id">{{item.name}}</el-option>
                  <!-- <el-option label="区域二" value="beijing"></el-option> -->
                </el-select>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="6">
              <el-form-item prop="expAreaName">
                <el-select v-model="form.expAreaName" placeholder="请选择省" @change="expAreaNameChange">
...
export default {
  ...
  async created(){
    ...
    const cityNamelist = await api.userzone.getAddressCity("32")
  ...
  methods:{
    async provinceNameChange(value){
      ...
      console.log("this.cityNamelistchange",this.cityNamelist)
    },
