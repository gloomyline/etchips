        ...
        <!-- <el-tab-pane label="增值税纸质普通发票"> -->
          ...
          <el-form ref="form" :model="form"  label-width="150px" width="600">
            ...
            <el-form-item label="选择购买项目" >
              ...
              <el-select v-model="form.orderNumber" placeholder="请选择购买选项">
                <el-option v-for="item in form.orderList" :label="item.label" :value="item.value" :key="item.id" @change="selected"></el-option>
...
<script>
  ...
  export default {
    ...
    methods: {
      async selected(val){
        var objcost=this.form.orderList.map(item=>{
