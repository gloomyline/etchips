  ...
  methods:{
    ...
    async submitForm(formName) {
      var addreslist = {
        ...
        cityName:this.form.provinceName,
        expAreaName:this.form.provinceName,
        address:this.form.provinceName,
        name:this.form.provinceName,
        mobile:'',
        company:this.form.provinceName
      }
      const saveAddress = await api.userzone.saveAddress(addreslist)
