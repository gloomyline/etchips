    ...
    <div class="container">
            ...
            <el-col :span="6">
              <el-form-item prop="provinceName">
                <el-select v-model="form.provinceName" placeholder="请选择省" @change="provinceNameChange">
                  <el-option v-for="item in form.provinceNamelist" :label="item.label" :value="item.value" :key="item.value"></el-option>
            ...
            <el-col :span="6">
              <el-form-item prop="cityName">
                <el-select v-model="form.cityName" placeholder="请选择市" @change="cityNameChange">
                  <el-option v-for="item in form.cityNamelist" :label="item.label" :value="item.value" :key="item.id"></el-option>
            ...
            <el-col :span="6">
              <el-form-item prop="expAreaName">
                <el-select v-model="form.expAreaName" placeholder="请选择区/县" @change="expAreaNameChange">
                  <el-option v-for="item in form.expAreaNamelist" :label="item.label" :value="item.value" :key="item.id"></el-option>
      ...
      <el-table
        ...
        <el-table-column label="收件人地址">
          <template slot-scope="scope">
            <span style="margin-left: 10px">{{ scope.row.provinceName1 }} / {{ scope.row.cityName1 }} / {{ scope.row.expAreaName1 }} / {{ scope.row.address }}</span>
          </template>
        </el-table-column>
        <el-table-column label="收件人手机">
          <template slot-scope="scope">
...
export default {
  ...
  async created(){
    ...
    this.form.provinceNamelist = provinceName.data.map((item)=>{
      return {
        label:item.name,
        value:item.id
      }
    ...
    console.log("provicenNamelist",this.form.provinceNamelist)
  ...
  methods:{
    ...
    handleEdit(index, row) {
      ...
      this.form.provinceName = row.provinceName1,
      this.form.cityName = row.cityName1,
      this.form.expAreaName = row.expAreaName1,
      //省市区文字
