        ...
        <div class="product-list">
          ...
          <el-table :data="product.list" stripe header-row-class-name="product-table-header" v-loading="tableLoading">
            ...
            <el-table-column label="物料" align="center" min-width="100">
              <template slot-scope="scope"> <div @click="gotoGoodDetails(scope.row.brandName, scope.row.materialNumber)" style="cursor: pointer;">{{ scope.row.materialNumber }}</div></template>
            </el-table-column>
