<template lang="html">
  <div class="et-search-box">
    <div class="wrap">
      ...
      <!-- <el-input placeholder="请输入后回车搜索" v-model="searchContent" class="search" @keyup.enter="gotoSearchResults"  v-on="$listeners"> -->
        <el-input placeholder="请输入后回车搜索" v-model="searchContent" class="search" @change="gotoSearchResults"  v-on="$listeners">
        <el-button slot="append" icon="el-icon-search" @click="gotoSearchResults"></el-button>
      </el-input>
